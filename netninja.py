...
def usage():
    print("NetNinja Tool")
    print()
    print("Usage: netninja.py -t target_host -p port")
    ...
    print()
    print("Examples: ")
    print("netninja.py -t 192.168.0.1 -p 5555 -l -c")
    print("netninja.py -t 192.168.0.1 -p 5555 -l -u=c:\\target.exe")
    print("netninja.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\"")
    print("echo 'ABCDEFGHI' | ./netninja.py -t 192.168.11.12 -p 135")
    sys.exit(0)
...
def client_handler(client_socket):
    ...
    if command:
        while True:
            ...
            client_socket.send("<NetNinja:#> ".encode())
